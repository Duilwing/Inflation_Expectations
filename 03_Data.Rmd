...
ggplot(data=infl_sum_US_sub) + aes(x=date, y = relative_rankings,color = searched_terms) + geom_line(size=0.9,alpha=0.8)+scale_color_manual(values=c("#287D8EFF","#FDE725FF"))+labs(x="months")+scale_x_date(date_labels = "%m",date_breaks = "2 months")+ theme_minimal()  
